...
object TcsClient {
  def main(args: Array[String]): Unit = {
    ...
    val xCoordinate: Key[Double] = KeyType.DoubleKey.make("Xcoordinate")
    val yCoordinate: Key[Double] = KeyType.DoubleKey.make("Ycoordinate")
    ...
    def run(options: Options): Unit = {
      ...
      if (options.convertRaDec) {
        ...
        val typedSystem: ActorSystem[SpawnProtocol.Command] =
